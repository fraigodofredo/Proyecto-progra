...
namespace Proyecto
{
	...
	public partial class Agregar : Form
	{
		...
		void BtnAgregarClick(object sender, EventArgs e)
		{
			...
			int id = MainForm.conexion.Insert(MainForm.Agenda[MainForm.i]);
			if(id<0){
				MessageBox.Show("Ha ocurrido un error en la incersion ");
			}
			else{
				MessageBox.Show("Tu numero de cliente es: " +id);
			}
